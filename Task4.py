...
def exp_func(x, y):
    return x ** y
print(f"Возведение {x} в степень {y} с оператором "**" результатом {exp_func(x, y)}")
...
print(f"Возведение {x} в степень {y} с использованием цикла результатом {exp_func2(x, y)}")
