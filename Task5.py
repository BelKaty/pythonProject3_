...
def sum_str():
    result = 0
    while True:
        numbers_str = input("Введите несколько чисел через пробел, а для завершения программы введите 'n': ").split()
...
print(f"Результат сложения всех введенных чисел: {sum_str()}")